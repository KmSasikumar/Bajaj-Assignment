...
[Start] | v [POST /generateWebhook] ----> { "regNo": "22BCE11638", ... } | v [Receive Response] <--------- { "accessToken": "...", "url": "..." } | v [Select Logic] -------------> REG NO ends in 38 (Even) -> Question 2 | v [Submit Solution] ----------> POST /testWebhook with JWT | v [Success]
